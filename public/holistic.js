...
*/
	...
	var Ca,
		Da = 'undefined' !== typeof TextDecoder,
		Ea,
		Fa = 'undefined' !== typeof TextEncoder;
	function Ga(a) {
	...
	function Sa(a) {
		...
		if (a.constructor === Pa) {
			if (null == a.g) var b = Oa || (Oa = new Uint8Array(0));
				...
				var c = a.g;
				c =
					null == c || (Na && null != c && c instanceof Uint8Array)
						? c
						: 'string' === typeof c
						? La(c)
						: null;
	...
	function Za(a) {
		...
		b = this.m;
		Wa.length
			? ((c = Wa.pop()), b && (c.u = b.u), a && Ua(c, a), (a = c))
			: (a = new Ta(a, b));
		this.g = a;
		this.l = this.g.g;
		this.h = this.i = -1;
		...
		switch (a.h) {
			...
			case 3:
				...
				do {
					...
					if (4 == a.h) {
						a.i != b &&
							((a.j = !0), ya(Error('Unmatched end-group tag')));
						break;
					}
					ab(a);
				} while (1);
	...
	function xb(a, b, c) {
		...
		if (!d) {
			...
			d = [];
			for (
				var g = Array.isArray(e) ? !!(kb(e) & 2) : !1, f = 0;
				f < e.length;
				f++
			)
	...
	function yb(a, b, c, d, e) {
		...
		a = ub(a, b);
		void 0 != e
			? (g.splice(e, 0, c), a.splice(e, 0, T(c)))
			: (g.push(c), a.push(T(c)));
	}
	...
	function Ab(a) {
		...
		switch (a.length) {
			...
			default:
				throw Error(
					'unsupported number of parameters, expected [2-4], got ' +
						a.length,
				);
		}
	}
	...
	function Gb(a, b, c) {
		...
		var g;
		if (Da)
			(g = Ca) || (g = Ca = new TextDecoder('utf-8', { fatal: !1 })),
			...
			for (var f = [], k = null, h, l, n; e < d; )
				(h = a[e++]),
					128 > h
						...
						: f.push(65533),
					8192 <= f.length && ((k = Ba(k, f)), (f.length = 0));
			g = Ba(k, f);
		}
		Q(b, c, g);
		return !0;
		...
		return H(function (p) {
			switch (p.g) {
				...
				case 2:
					...
					if ('object' === typeof window)
						return (
							Ec('createMediapipeSolutionsWasm', {
							...
							(l = Promise.all(
								k.map(function (m) {
									return void 0 === m.simd ||
										(m.simd && c) ||
										(!m.simd && !c)
										? Fc(a.locateFile(m.url, a.S))
										: Promise.resolve();
								}),
							).then(function () {
								var m, q, t;
...
*/
	...
	x.setOptions = function (a, b) {
		...
		if ((b = b || this.g.options)) {
			for (
				var d = [], e = [], g = {}, f = B(Object.keys(a)), k = f.next();
				!k.done;
	...
	function Lc(a, b) {
		...
		g = a.h.PacketListener.implement({
			onResults: function (k) {
				...
				var n = a.listeners[c];
				n &&
					(a.C = Nc(a, h, b.outs).then(function (r) {
						r = n(r);
			...
			options: {
					...
					onChange: function (c) {
						...
						return H(function (k) {
							if (1 == k.g) {
								...
								e =
									'third_party/mediapipe/modules/pose_landmark/' +
									d;
								g = b.g.locateFile(d, '');
				...
				smoothLandmarks: {
					...
					graphOptionXref: {
						calculatorType: 'ConstantSidePacketCalculator',
						calculatorName:
							'ConstantSidePacketCalculatorSmoothLandmarks',
						fieldName: 'bool_value',
					},
				},
				enableSegmentation: {
					...
					graphOptionXref: {
						calculatorType: 'ConstantSidePacketCalculator',
						calculatorName:
							'ConstantSidePacketCalculatorEnableSegmentation',
						fieldName: 'bool_value',
					},
				},
				smoothSegmentation: {
					...
					graphOptionXref: {
						calculatorType: 'ConstantSidePacketCalculator',
						calculatorName:
							'ConstantSidePacketCalculatorSmoothSegmentation',
						fieldName: 'bool_value',
					},
				},
				refineFaceLandmarks: {
					...
					graphOptionXref: {
						calculatorType: 'ConstantSidePacketCalculator',
						calculatorName:
							'ConstantSidePacketCalculatorRefineFaceLandmarks',
						fieldName: 'bool_value',
					},
				},
